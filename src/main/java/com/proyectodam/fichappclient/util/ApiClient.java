...
public class ApiClient {
    ...
    public String getDocumentoServiceYControladorCalendario(String endpoint) throws IOException, InterruptedException {
    ...
    public String postNominaYControladorCalendario(String endpoint, String jsonBody) throws IOException, InterruptedException {
        String fullUrl = getBaseUrl() + endpoint;
    ...
    public String putControladorConfiguracion(String endpoint, String jsonBody) throws IOException, InterruptedException {
        String fullUrl = getBaseUrl() + endpoint;
    ...
    public String deleteDocumentoServiceYControladorCalendario(String endpoint) throws IOException, InterruptedException {
        String fullUrl = getBaseUrl() + endpoint;
    ...
    private String sendRequest2(HttpRequest request) throws IOException, InterruptedException {
        HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
