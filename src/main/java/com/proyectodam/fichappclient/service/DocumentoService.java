...
public class DocumentoService {
    ...
    public List<DocumentoDTO> listarTodos() throws Exception {
        String response = apiClient.getDocumentoServiceYControladorCalendario("/documentos/all");
    ...
    public void eliminarDocumento(Long idDocumento) throws Exception {
        apiClient.deleteDocumentoServiceYControladorCalendario("/documentos/" + idDocumento);
    }
