...
public class FichajeHoyDTO {
    ...
    public String getTimeStampServidor() { return timeStampServidor; }
    public void setTimeStampServidor(String timeStampServidor) { this.timeStampServidor = timeStampServidor; }
}
